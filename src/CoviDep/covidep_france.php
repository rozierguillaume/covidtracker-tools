...
<div class="entry">
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <br>
            Vous pouvez sélectionner un département dans
            la liste ci-dessous, ou en cliquant sur la carte de France. Les
            ...
            <div class="text-center">
                <select name="deps_list_choice" id="listeDepartements" class="select2">
                    ...
                    <option data-num="04" data-article="des " value="Alpes-de-Haute-Provence">04 - Alpes-de-Haute-Provence</option>
        ...
        <div class="body">
            ...
            <div class="donnee Cas" style="margin-top:30px;">
                ...
                <div class="row france">
                    ...
                    <div class="col-md-10">
                        <progress style="" type="grey" id="moyenneIncidenceCas"
                                  value="0" max="1">
                        </progress>
                    </div>
                </div>
                <div class="row departementCourant">
                    ...
                    <div class="col-md-10">
                        <progress style="" type="" id="currentDepartmentIncidenceCas"
                                  value="0" max="1">
                        </progress>
                    </div>
                </div>
            ...
            <div class="donnee Hospitalisations" style="margin-top:70px;">
                ...
                <div class="row departementCourant">
                    ...
                    <div class="col-md-10">
                        <progress style="" type="red" id="currentDepartmentIncidenceCas"
                                  value="0" max="1">
                        </progress>
                    </div>
                </div>
                <p>
                    Dans le département <span class="articleDepartement"></span><span class="nomDepartment"></span> il y
                    a eu <span class="incidence"></span>
                    admissions en hospitalisation pour 100 000 habitants cette semaine.<br>
                    C’est <span class="difference"></span> plus <span class="sens"></span> que la moyenne française.
                </p>
            </div>
            ...
            <div class="donnee Reanimations" style="margin-top:70px;">
                ...
                <p>
                    Dans le département <span class="articleDepartement"></span><span class="nomDepartment"></span> il y
                    a eu <span class="incidence"></span>
                    admissions en réanimation pour 100 000 habitants cette semaine.<br>
                    C’est <span class="difference"></span> plus <span class="sens"></span> que la moyenne française.
                </p>
            </div>
            ...
            <div class="donnee Deces" style="margin-top:70px;">
                ...
                <p>
                    Dans le département <span class="articleDepartement"></span><span class="nomDepartment"></span> il y
                    a eu <span class="incidence"></span>
                    nouveaux décès pour 100 000 habitants cette semaine.<br>
                    C’est <span class="difference"></span> plus <span class="sens"></span> que la moyenne française.
                </p>
            </div>
        </div>
    ...
    <script>
        jQuery(document).ready(function ($) {
            ...
            function affichageInfosDepartement() {
                ...
                nomDepartement = $("#listeDepartements option:selected").val();
                nunmeroDepartement = $("#listeDepartements option:selected").data("num");
                articleDepartement = $("#listeDepartements option:selected").data("article");

                donneesDepartement = donneesDepartements[nomDepartement];

                $('span.nomDepartment').text(nomDepartement);
                $('span.articleDepartement').text(articleDepartement);

                $('#carte path').removeClass('selected');
                if (nomDepartement) {
                ...
                const typesDonnee = ['Cas', 'Hospitalisations', 'Reanimations', 'Deces'];


                typesDonnee.forEach(function (typeDonnee) {

                    //On va pour chaque type de données récuéprer les données qui vont bien.
                    switch (typeDonnee) {
                        case 'Cas' :
                            incidenceDepartement = donneesDepartement['incidence_cas'];
                            incidenceFrance = incidenceCasFrance;
                            incidenceMax = incidenceCasMax;
                            precision = 0;
                            break;
                        case 'Hospitalisations' :
                            incidenceDepartement = donneesDepartement['incidence_hosp'];
                            incidenceFrance = incidenceHospitalisationsFrance;
                            incidenceMax = incidenceHospitalisationsMax;
                            precision = 0;
                            break;
                        case 'Reanimations' :
                            incidenceDepartement = donneesDepartement['incidence_rea'];
                            incidenceFrance = incidenceReaFrance;
                            incidenceMax = incidenceReaMax;
                            precision = 1;
                            break;
                        case 'Deces' :
                            incidenceDepartement = donneesDepartement['incidence_dc'];
                            incidenceFrance = incidenceDecesFrance;
                            incidenceMax = incidenceDecesMax;
                            precision = 1;
                            break;
                    }
                    ...
                    if (incidenceDepartement > incidenceFrance) {
                        difference = ((incidenceDepartement - incidenceFrance) * 100 / incidenceFrance).toFixed(0);
                        $('#donneesDepartment .' + typeDonnee + ' span.difference').text('+' + difference + ' %');
                        $('#donneesDepartment .' + typeDonnee + ' span.sens').text('élevé');
                        $('#donneesDepartment .' + typeDonnee + ' .departementCourant progress').attr('type', 'red');
                        $('#donneesDepartment .' + typeDonnee + ' .difference.titre').addClass('red').removeClass('green');
                    } else {
                        difference = ((incidenceFrance - incidenceDepartement) * 100 / incidenceFrance).toFixed(0);
                        $('#donneesDepartment .' + typeDonnee + ' span.difference').text('-' + difference + ' %');
                        $('#donneesDepartment .' + typeDonnee + ' span.sens').text('bas');
                        $('#donneesDepartment .' + typeDonnee + ' .departementCourant progress').attr('type', 'green');
                        $('#donneesDepartment .' + typeDonnee + ' .difference.titre').addClass('green').removeClass('red');
                    }

                    //Affichage des progress bar et valeurs département et france.
                    $('#donneesDepartment .' + typeDonnee + ' progress').attr('max', incidenceMax.toFixed(precision));
                    $('#donneesDepartment .' + typeDonnee + ' progress').attr('value', 0);
                    $('#donneesDepartment .' + typeDonnee + ' .france progress').animate({
                        value: incidenceFrance
                    }, 1000);
                    $('#donneesDepartment .' + typeDonnee + ' span.incidence').text(incidenceDepartement.toFixed(precision));
                    $('#donneesDepartment .' + typeDonnee + ' .departementCourant progress').animate({
                        value: incidenceDepartement
                    }, 1000);
            ...
            fetch('https://raw.githubusercontent.com/rozierguillaume/covid-19/master/data/france/stats/incidence_departements.json')
                ...
                .then(json => {
                   ...
                   // console.log(date_update);
                    ...
                    incidenceCasMax = 0;
                    incidenceHospitalisationsMax = 0;
                    incidenceReaMax = 0;
                    incidenceDecesMax = 0;

                    //Inititlisation des moyennes nationales
                    incidenceCasFrance = donneesFrance['incidence_cas'];
                    incidenceHospitalisationsFrance = donneesFrance['incidence_hosp'];
                    incidenceReaFrance = donneesFrance['incidence_rea'];
                    incidenceDecesFrance = donneesFrance['incidence_dc'];

                    //Recherche des valeurs maximales.
                    for (department in donneesDepartements) {
                        donneesDepartement = donneesDepartements[department];
                        if (donneesDepartement['incidence_cas'] > incidenceCasMax) {
                            incidenceCasMax = donneesDepartement['incidence_cas'];
                        }
                        if (donneesDepartement['incidence_hosp'] > incidenceHospitalisationsMax) {
                            incidenceHospitalisationsMax = donneesDepartement['incidence_hosp'];
                        }
                        if (donneesDepartement['incidence_rea'] > incidenceReaMax) {
                            incidenceReaMax = donneesDepartement['incidence_rea'];
                        }
                        if (donneesDepartement['incidence_dc'] > incidenceDecesMax) {
                            incidenceDecesMax = donneesDepartement['incidence_dc'];
                        }
                    }

                    // console.log(donneesDepartements);
                    // console.log(donneesFrance);
                    affichageInfosDepartement();
                    // console.log('Incidence cas max :' + incidenceCasMax);
                    // console.log('Incidence hospi max :' + incidenceHospitalisationsMax);
                    // console.log('Incidence rea max :' + incidenceReaMax);
                    // console.log('Incidence décès max :' + incidenceDecesMax);
                    //
                    // console.log('Incidence cas moy :' + incidenceCasFrance);
                    // console.log('Incidence hospi moy :' + incidenceHospitalisationsFrance);
                    // console.log('Incidence rea moy :' + incidenceReaFrance);
                    // console.log('Incidence décès moy :' + incidenceDecesFrance);
    ...
    <style>
        #donneesDepartment progress {
            height: 8px;
        }

        #donneesDepartment span {
            font-weight: bold;
        }

        #donneesDepartment span.articleDepartement {
            font-weight: normal;
        }
        ...
        .donnee p, .donnee div.row.france {
            margin-top: 30px;
        }
        ...
        #donneesDepartment {
            ...
            max-width: 1200px;
            /*text-align: left;*/
            /*box-shadow: 6px 4px 10px #3a3a3a;*/
            /*box-shadow: 0 0 0 transparent, 0 0 0 transparent, 6px 4px 10px #3a3a3a;*/
            /*background: #ffffff;*/
            border: 0px solid black;
            padding: 20px 20px;
            border-radius: 7px;
        ...
        progress::-webkit-progress-value { /* Firefox */
            background-color: rgba(0, 0, 0, 0);
            border-radius: 5px;
        }

        progress[type=grey]::-moz-progress-bar { /* Mozilla */
            background: #cacaca;
        }

        progress[type=grey]::-webkit-progress-value { /* Safari/Chrome */
            background: #cacaca;
            border-radius: 5px;
        }

        progress[type=grey]::-webkit-progress-bar { /* Safari/Chrome */
            background: #cacaca;
            background-color: #fff !important;
            border-radius: 5px;
        }

        progress[type=green]::-moz-progress-bar { /* Mozilla */
            background: green;
        ...
        progress[type=red]::-moz-progress-bar { /* Mozilla */
            background: red;
            background-color: red;
        }
