<!-- wp:heading -->
<h3>Répartition des cas en fonction de l'âge</h3>
<!-- /wp:heading -->

<!-- wp:paragraph -->
<p>Cette carte présente l'incidence, c'est-à-dire le nombre de tests positifs sur une semaine dans chaque département, ramené à 100 000 habitants. Un département est considéré comme rouge si son incidence dépasse 50 cas pour 100k habitants.</p>
<!-- /wp:paragraph -->

<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item active">
        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#heatMapIncidence" role="tab" aria-controls="home" aria-selected="true">
            Heatmap Incidence
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#heatMapCas" role="tab" aria-controls="profile" aria-selected="false">
            Heatmap Cas
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="contact-tab" data-toggle="tab" href="#heatMapPositivite" role="tab" aria-controls="contact" aria-selected="false">
            Heatmap Positivité
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="contact-tab" data-toggle="tab" href="#heatMapAge" role="tab" aria-controls="contact" aria-selected="false">
            Répartition suivant l'âge
        </a>
    </li>
</ul>
<div class="tab-content" id="myTabContent">
    <div class="tab-pane active in" id="heatMapIncidence" role="tabpanel" aria-labelledby="heatMapIncidence-tab">
