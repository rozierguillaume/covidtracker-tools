...
<p><!-- wp:paragraph --></p>
<p>Le graphique suivant présente le taux de positivité. Cela correspond à la proportion de tests positifs par rapport à l'ensemble des tests réalisés, positifs ou négatifs.</p>
<p><!-- /wp:paragraph --></p>
<p><!-- wp:paragraph --></p>
<p>Dans le deuxième onglet, ce graphique est décliné pour chaque département. Il est conseillé de cliquer sur l'image, puis de zoomer afin d'observer correctement chaque département.</p>
<!-- /wp:paragraph -->

<ul class="nav nav-tabs" id="myTab" role="tablist">
    <li class="nav-item active">
        <a class="nav-link active" id="home-tab" data-toggle="tab" href="#TPFrance" role="tab" aria-controls="home" aria-selected="true">
            France
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#TPDepartements" role="tab" aria-controls="profile" aria-selected="false">
            Départements
        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" id="profile-tab" data-toggle="tab" href="#TPClassesAge" role="tab" aria-controls="profile" aria-selected="false">
            Classes d'âge
        </a>
    </li>
</ul>
