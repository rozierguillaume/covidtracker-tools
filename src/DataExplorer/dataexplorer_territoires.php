...
var descriptions = {
    ...
    "taux_positivite": "Proportion des tests qui sont positifs (en %). Calcul : moyenne(positifs / total). Par date de prélèvment (J-3).",
    "taux_positivite_rolling_before": "Proportion des tests qui sont positifs (en %). Par date de prélèvment (J-3). <small>Calcul : moyenne_mobile(tests_positifs) / moyenne_mobile(total_tests).</small>",
    ...
    "cas": "Nombre de tests positifs quotidiens (RT-PCR et antigéniques) (moyenne glissante 7 jours). Par date de prélèvment (J-3).",
    "tests": "Nombre de tests quotidiens (positifs et négatifs) (moyenne glissante 7 jours). Par date de prélèvment (J-3).",
