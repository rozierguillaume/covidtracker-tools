...
<body>
    ...
    <div id="cas" style="width: 95vw; height: 35vw; max-width: 1200px; max-height: 800px; min-height: 300px;"></div>
    ...
    <div id="cas_taux_croissance" style="width: 95vw; height: 35vw; max-width: 1200px; max-height: 800px; min-height: 300px;"></div>
    <span>CovidTracker.fr • Données : Santé publique France • Dernière donnée : <span class="date_maj">--/--</span></span>
    ...
    <div id="cas_spf" style="width: 95vw; height: 35vw; max-width: 1200px; max-height: 800px; min-height: 300px;"></div>
    ...
    <div id="cas_spf_taux_croissance" style="width: 95vw; height: 35vw; max-width: 1200px; max-height: 800px; min-height: 300px;"></div>
    <span>CovidTracker.fr • Données : Santé publique France • Dernière donnée : <span class="date_maj_spf_opendata">--/--</span></span>
    ...
    <div id="cas_taux_positivite" style="width: 95vw; height: 35vw; max-width: 1200px; min-height: 300px; max-height: 800px;"></div>
    <span>CovidTracker.fr • Données : Santé publique France • Dernière donnée : <span class="date_maj">--/--</span></span>

    <h2>Dépistage</h2>
    <h3>Nombre de tests effectués</h3>
    <p>Nombre total de tests Covid effectués chaque jour (antigéniques et PCR).</p>
    <div id="tests" style="width: 95vw; height: 35vw; max-width: 1200px; min-height: 300px; max-height: 800px;"></div>
    <span>CovidTracker.fr • Données : Santé publique France • Dernière donnée : <span class="date_maj">--/--</span></span>
    <br>
    ...
    <div id="tests_taux_croissance" style="width: 95vw; height: 35vw; max-width: 1200px; min-height: 300px; max-height: 800px;"></div>
    <span>CovidTracker.fr • Données : Santé publique France • Dernière donnée : <span class="date_maj">--/--</span></span>
