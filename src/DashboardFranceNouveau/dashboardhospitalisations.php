...
<body>
    ...
    <div id="lits_hospitalisations" style="width: 95vw; height: 35vw; max-width: 1200px; max-height: 800px; min-height: 300px;"><span>CovidTracker.fr • Données : Santé publique France • Dernière donnée : <span class="date_maj">--/--</span></span></div>
    ...
    <div id="hospitalisations_taux_croissance" style="width: 95vw; height: 35vw; max-width: 1200px; max-height: 800px; min-height: 300px;"><span>CovidTracker.fr • Données : Santé publique France • Dernière donnée : <span class="date_maj">--/--</span></span></div>
    
    <h3>Hospitalisations par âge</h3>
    <p>Personnes actuellement hospitalisées avec Covid19, par tranche d'âge.</p>
    <div id="hospitalisations_par_age" style="width: 95vw; height: 35vw; max-width: 1200px; max-height: 800px; min-height: 300px;"><span>CovidTracker.fr • Données : Santé publique France • Dernière donnée : <span class="date_maj">--/--</span></span></div>
    ...
    <div id="nouvelles_hospitalisations" style="width: 95vw; height: 35vw; max-width: 1200px; max-height: 800px; min-height: 300px;"><span>CovidTracker.fr • Données : Santé publique France • Dernière donnée : <span class="date_maj">--/--</span></span></div>
    ...
    <div id="nouvelles_hospitalisations_taux_croissance" style="width: 95vw; height: 35vw; max-width: 1200px; min-height: 300px; max-height: 800px;"><span>CovidTracker.fr • Données : Santé publique France • Dernière donnée : <span class="date_maj">--/--</span></span></div>
