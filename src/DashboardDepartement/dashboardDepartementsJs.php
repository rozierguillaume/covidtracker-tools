<script>
    jQuery(document).ready(function ($) {
            ...
            var couleurs_cas_12_couleurs = [
                "#3c0000", "#4c0000", "#6a0000", "#840000", "#a00000", "#c40001", "#d50100", 
                "#e20001", "#f50e07", "#f95228", "#fb9449", "#98ac3b", "#118408"];
            ...
            var valeurs_var_c1 = ["100", "98", "96", "94", "92", "90", "87", "84", "81", "78", "75", "50"]
            //["100", "95", "90", "85", "80", "75", "70", "65", "60", "55", "45", "40"];
            var couleurs_var_c1 = [
                '#00004d', '#17175a', '#292b68', '#393f76', '#475484', '#566a92', 
                '#6680a0', '#7696ae', '#88adbd', '#9cc4cb', '#b5dada', '#e9e9e9']
            //['#000f5c', '#162169', '#263376', '#334683', '#405990', '#4d6d9d', '#5a80a9', '#6995b5', '#79a9c0', '#8dbdcb', '#a5d1d3', '#dedecc']
            //['#00429d', '#2250a4', '#345eaa', '#436db0', '#507cb7', '#5e8bbd', '#6b9ac2', '#78a9c8', '#87b9cd', '#97c8d1', '#aad7d4', '#dedecc']
            //['#00429d', '#2552a5', '#3863ad', '#4874b4', '#5786bc', '#6497c4', '#72a9cc', '#80bbd5', '#90cedd', '#a0e0e6', '#b5f1f0', '#d8ffff']

            var valeurs_evolution = [">", "40", "30", "20", "10", "5", "0", "-5", "-10", "-20", "-30", "-40", "-50"];
            var couleurs_evolution = [
                 '#93003a', '#bb1d4b', '#d84560', '#ec6e77', '#f79792', '#f8c2af', 
                 '#ededce', '#a8d6d4', '#87b8cc', '#6b9ac2', '#517bb6', '#345eaa', '#00429d'];
