...
<div class="row">
    <div class="col-md-12">
        ...
        <div shadow="" style="margin-bottom: 20px;">
            <div >
                <div style="text-align: left">
                    <h3>Dashboards</h3>
                    <p>Ces tableaux de bord permettent de suivre et mieux comprendre l'évolution de l'épidémie.</p>
                    <div class="links-tools-list">
        ...
        <div shadow="" >
            <div style="text-align: left">
                ...
                <div class="links-tools-list">
                    ...
                    <a href="https://covidtracker.fr/archives/" style="color:black"><button><i>Outils archivés</i></button></a>
                </div>
            </div>
        </div>
    </div>
