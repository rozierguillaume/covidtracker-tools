...
<body>
    ...
    <p>Ci-dessous les résultats produits par le modèle il y a 7 jours, comparé aux valeurs réelles observées. Cela permet de mesurer la justesse du modèle.</p>
    <p><img src="https://raw.githubusercontent.com/CovidTrackerFr/forecast/main/output/model_booster_lastweek_fit.png" <="" img=""></p>
    ...
    <p>Notons que ce modèle est meilleur pour projeter les admissions à l'hôpital, en soins critiques, et les décès que les cas positifs, car ces variables dépendent en partie des cas passés (ceux-ci étant certaines, car déjà observés). Par ailleurs, en l'absence de choc particulier, le modèle aura tendance à stabiliser les cas : par exemple en période de hausse épidémique, il aura tendance à projeter un pic de cas un peu plus tôt, ou un peu plus bas que ce qui devrait se réaliser.</p>
    ...
    <img src="https://raw.githubusercontent.com/CovidTrackerFr/forecast/main/output/model_booster_fit.png" <="" img="">

    <h2>Résultats de la semaine dernière</h2>

    <p>Ci-dessous les résultats produits par le modèle il y a 7 jours, comparé aux valeurs réelles observées. Cela permet de mesurer la justesse du modèle.</p>

    <img src="https://raw.githubusercontent.com/CovidTrackerFr/forecast/main/output/model_booster_lastweek_fit.png" <="" img="">
