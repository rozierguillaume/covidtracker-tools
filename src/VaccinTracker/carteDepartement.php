...
<div id="menu" class="row">
    <div class="col-md-6 text-center">
        ...
        <div class="alert alert-info">
            05 novembre 2021 : attention, depuis ce jour la carte affiche le nombre de personnes vaccinées par lieu de résidence, et non plus par lieu d'injection. Une personne habitant à Paris et vaccinée dans les Yvelines est désormais comptaibilisée à Paris.
        </div>
    </div>
