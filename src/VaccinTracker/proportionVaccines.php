...
<div class="row">
    ...
    <div class="col-md-4" style="padding-top: 20px;">
        <span style="font-size: 200%; color: rgb(45, 189, 84)"><span id="proportionVaccinesMax">--</span>%</span><br> des Français ont reçu au moins une dose de vaccin, <span style="color: rgb(31, 128, 57)"><span id="proportionVaccinesTotalement">--</span>%</span> ont reçu les deux doses.<br><br>
