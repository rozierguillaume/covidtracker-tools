...
Chaque carré correspond à 1% des Français. Les carrés verts foncés <svg width="10" height="10"><rect x="0" y="0" width="60" height="60" style="fill:rgb(31, 128, 57);" /></svg> correspondent aux Français ayant reçu 2 doses et les carrés verts clairs <svg width="10" height="10"><rect x="0" y="0" width="60" height="60" style="fill:rgb(45, 189, 84);" /></svg> aux Français en ayant reçu une. Les carrés rouge vif <svg width="10" height="10"><rect x="0" y="0" width="60" height="60" style="fill:rgb(237, 88, 88);" /></svg> représentent les Français qu'il faut vacciner avant d'atteindre un taux de vaccination de 60%.
...
<div class="row">
    ...
    <div class="col-md-4" style="padding-top: 20px;">
        <span style="font-size: 200%; color: rgb(45, 189, 84)"><span id="proportionVaccinesMax">--</span>%</span><br> des Français ont reçu au moins une dose de vaccin, <span style="color: rgb(31, 128, 57)"><span id="proportionVaccines2doses">--</span>%</span> ont reçu les deux doses.<br><br>
