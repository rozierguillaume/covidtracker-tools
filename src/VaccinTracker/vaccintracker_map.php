...
<div class="row" style="margin-left: 2px;">
    ...
    <button class="btn-shadow"><a href="https://lydia-app.com/collect/covidtracker/fr" target="_blank"
                                  rel="noreferrer noopener">🍩 Offrez-moi un donut</a></button> &nbsp;&nbsp;
</div>
<!-- /wp:html -->
...
<div class="wrap">
    <div class="one">
        <span id="nb_vaccines" style="font-size:200%; margin-top:5px; margin-bottom: 3px;">--</span>&nbsp;&nbsp;(+<span
                id="nb_vaccines_24h">--</span> en 24h)<br>
        <b>Personnes vaccinées</b><br>
        Nombre cumulé de personnes ayant reçu au moins une dose de vaccin contre la Covid19 en France. <span
                id="proportion_doses">--</span>% des doses réceptionnées ont été utilisées.<br><span
                id="estimation_str"></span>
        <div style="font-size: 70%; margin-top: 3px;"><i>Dernière donnée : <span id="date_maj_2">--/--</span>.<br>Source
                : CovidTracker/Ministère de la Santé.</i></div>
    </div>

    <div class="one">
        <span id="nb_doses" style="font-size:200%; margin-top:5px; margin-bottom: 3px;">--</span><br>
        <b>Doses réceptionnées</b><br>
        Cumul des doses réceptionnées depuis le 26 décembre. Deux doses espacées de trois semaines sont nécessaires pour
        vacciner un patient.<br>
        <div style="font-size: 70%; margin-top: 3px;"><i>Dernière donnée : <span id="date_maj_4">--/--</span>.<br>Source
                : CovidTracker/Ministère de la Santé.</i></div>
    </div>
</div>

<h2 style="margin-top : 80px;">Proportion de personnes vaccinées</h2>
Chaque carré correspond à 1% des Français. Les carrés verts
<svg width="10" height="10">
    <rect x="0" y="0" width="60" height="60" style="fill:rgb(45, 189, 84);"/>
</svg> correspondent aux Français ayant reçu au moins une dose de vaccin (deux sont nécessaires). Les carrés rouge vif
<svg width="10" height="10">
    <rect x="0" y="0" width="60" height="60" style="fill:rgb(237, 88, 88);"/>
</svg> représentent les Français qu'il faut vacciner avant d'atteindre un taux de vaccination de 60%.
Les carrés rouge clair
<svg width="10" height="10">
    <rect x="0" y="0" width="60" height="60" style="fill: rgb(207, 169, 169);"/>
</svg>  représentent les autres Français non vaccinés. <i>Mise à jour : <span id="date_maj_3">--/--</span></i>
...
<div class="row">
    ...
    <div class="col-md-3" style="padding-top: 20px;">
        ...
        <span style="font-size: 200%; color: rgb(45, 189, 84)"><span id="proportionVaccines">--</span>%</span><br> des
        Français ont reçu au moins une dose de vaccin. <br><br>
        Il reste à vacciner au moins <br><span style="font-size: 200%; color: rgb(237, 88, 88);"><span
                    id="proportionAVaccinerImmu">--</span>%</span><br>des Français avant d'atteindre un taux de
        vaccination de 60%. <br>
    </div>
</div>
<br>
...
L'objectif est de vacciner 1 million de personnes en janvier 2021. Pour atteindre cet objectif, il faudrait vacciner <b><span
            id="objectif_quotidien">--</span> personnes</b> chaque jour entre aujourd'hui et le 31 janvier 2021.
<br>
<br>
Au rythme actuel
<small>(moyenne des 7 derniers jours)</small>, l'objectif du million de personnes vaccinées sera atteint le <b><span
            id="date_projetee_objectif"></span></b>.
...
<?php include(__DIR__ . '/carteRepartitionVaccins.php') ?>
...
<div style="border: 0px solid grey; background-color: rgba(128, 128, 128, 0.1); border-radius: 7px; padding: 12px;">
    ...
    <div class="row">
        ...
        <button class="shadow-btn col-xs-11 col-md-4"><b>🇺🇸🇧🇪 Janssen J&J</b><br>
            ...
            Prêt : fin janvier 2021<br>Conservation : +5°C<br>Commandes UE : 200M (+ option 200M)<br>Doses à injecter :
            1
            (essai en cours) ou 2<br>Statut : --
        </button>
        <button class="shadow-btn col-xs-11 col-md-4"><b>🇩🇪 CureVac</b><br>
            Phase 2/3<br>
            Type : ARN messager<br>
            Efficacité annoncée : --%<br>
            Prêt : 1er semestre 2021<br>Conservation : -60°C (3 mois), +5°C (3 mois)<br>Commandes UE : 225M (+ option
            180M)<br>Doses à injecter : 2<br>Statut : --
        </button>
...
<br><br>
<iframe width="560" height="315" src="https://www.youtube.com/embed/bjFtFMilb34" frameborder="0"
...
<ul>
    ...
    <li>Personnes en situation de handicap vulnérables qui sont hébergées en maison d'accueil spécialisées (MAS) et en
...
<ul>
    <li>Personnes âgées de plus de 75 ans en priorité ; puis personnes âgées de plus de 65 ans dans un second temps,
    </li>
</ul>
...
<iframe src="https://ourworldindata.org/grapher/covid-vaccination-doses-per-capita?tab=chart&stackMode=absolute&time=latest&region=World"
...
<iframe src="https://ourworldindata.org/grapher/cumulative-covid-vaccinations?tab=chart&stackMode=absolute&time=latest&region=World"
        loading="lazy" style="width: 100%; height: 600px; border: 0px none;"></iframe>
<br>
<br>
...
/
center >
< p > Ces tableaux de bord permettent de suivre et mieux comprendre l
...
/
center >
< p > Ces outils permettent de comparer les deux vagues, de calculer le risque de présence d

'un cas de covid19, et d'
estimer la durée du confinement en cours.<
...
=
"https://covidtracker.fr/deconfitracker/"
style

=
"color:black"
> < button > 🔥 DéconfiTracker<
...
=
"https://covidtracker.fr/archives/"
style

=
"color:black"
> < br > < i > Outils archivés<
...
=
"https://lydia-app.com/collect/covidtracker/fr"
target
